...
/**
 * These options allow you to modify the error generated by the middleware when the request doesn't
 * have a valid token.
 *
 * @typedef {Object} EnsureBearerTokenErrorOptions
 * @property {string} message  The error message for the response. Default `'Unauthorized'`.
 * @property {number} status   The HTTP status that will be added to error context information.
 *                             Default `401`.
 ...
 * @property {EnsureBearerTokenErrorOptions} error      The options to modify the error generated
 *                                                      by the middleware when the request doesn't
 *                                                      have a valid token.
 * @property {RegExp}                        expression The regular expression used to extract the
 *                                                      token from the request authorization
 *                                                      header.
...
class EnsureBearerToken {
  /**
   * @param {ClassAppError}                     AppError     To format the error caused when the
   *                                                         request doesn't have a valid token.
   * @param {Partial<EnsureBearerTokenOptions>} [options={}] The options to customize the
   *                                                         middleware behavior: how to validate
   *                                                         the token, how to save it and what
   *                                                         kind of error should generate.
   */
